...
@Slf4j
@Component
public class SimpleSendTextMail {
	...
	public boolean sendEmail(String recipientEmail, String subject, String body) {
		try {
			...
			String jsonBody = createEmailJson(recipientEmail, subject, body);
	...
	private String createEmailJson(String recipientEmail, String subject, String body) {
